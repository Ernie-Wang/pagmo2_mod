 ...
 */
constexpr int pso_vonNeumann_neighb_diff[4][2] = {{-1, 0}, {1, 0}, {0, -1}, {0, 1}};
 ...
 */
population pso::evolve(population pop) const
{
 ...
 */
std::string pso::get_extra_info() const
{
 ...
 */
vector_double pso::particle__get_best_neighbor(population::size_type pidx,
 ...
 */
void pso::initialize_topology__gbest(const population &pop, vector_double &gbX, vector_double &gbfit,
 ...
 *  @param[out] neighb definition of the swarm's topology
 */
void pso::initialize_topology__lbest(std::vector<std::vector<vector_double::size_type>> &neighb) const
{
 ...
 *  @param[out] neighb definition of the swarm's topology
 */
void pso::initialize_topology__von(std::vector<std::vector<vector_double::size_type>> &neighb) const
{
 ...
 *  @param[out] neighb definition of the swarm's topology
 */
void pso::initialize_topology__adaptive_random(std::vector<std::vector<vector_double::size_type>> &neighb) const
{
    auto swarm_size = neighb.size();
